...
export default function ProjectCapstoneCard() {
	...
	return (
		<div
			ref={cardRef}
			className="scroll-mt-30 w-[95%] bg-white/10 border border-amber-400 rounded-xl text-white p-5 shadow-md hover:shadow-amber-400/30 transition-all duration-300 hover:scale-101"
		>
			<MotionCard>
				{/* Header */}
				...
				<p className="text-sm leading-relaxed text-gray-200">
					Collaborated with a team of 10 developers to build a student
					enrollment management website for CS Capstone. Designed the website
					interface using Figma, adhering to the Cameron University branding
					guidelines. Developed front-end features to ensure a smooth and
					visually appealing user experience, including user login, student
					listings, and internship listings.
				</p>
